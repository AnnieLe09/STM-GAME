...
var DESIGN_RESOLUTION_WIDTH = 480;
var DESIGN_RESOLUTION_HEIGHT = 800;
cc.game.onStart = function () {
    ...
    cc.LoaderScene.preload(g_resources, function () {
        ...
        //fr.view(ScreenMenu);
        gv.mainController = new MainController();
        gv.inventoryController = new InventoryController();
        gv.chestController = new ChestController();
        gv.cheatController = new CheatController();
        gv.shopController = new ShopController();
