var FrozenSpell = Spell.extend({
    ctor:function(){
        //Spell.prototype.ctor(3).call();
        //this.init(3);
        this._super(1);
        this.effectTick = 5 * GC.BATTLE.TICK_PER_SECOND;
        this.range = 0.8;
        this.leftTick = 1;
        this.animTick = 30;
    },
    ...
    update:function (monsters, towers){
        cc.log("FrozenSpell update:" + this.leftTick + ", curpos: " + this.curPos.x + " " + this.curPos.y);
        if(this.leftTick > 0){
            if(this.animTick > 0){
                this.animTick--;
            }
    ...
    initAnim:function (){
        ...
        this.anim.addAnimation(0,"animation_ice_ball", false, 0);
