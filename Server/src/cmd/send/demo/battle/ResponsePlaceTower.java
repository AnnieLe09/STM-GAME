...
public class ResponsePlaceTower extends BaseMsg {
    private int tick;
    ...
    public ResponsePlaceTower(Short error, int tick, String battleId, int i, int j,
                              BattleController battleController, boolean isSwap) {
        super(CmdDefine.PLACE_TOWER,error);
        this.tick = tick;
