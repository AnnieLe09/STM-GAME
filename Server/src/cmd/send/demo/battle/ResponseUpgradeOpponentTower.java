...
public class ResponseUpgradeOpponentTower extends BaseMsg {
    private int tick;
    ...
    public ResponseUpgradeOpponentTower(Short error, int tick, String battleId, int i, int j,
                                        BattleController battleController, boolean isSwap) {
        super(CmdDefine.UPGRADE_OPPONENT_TOWER,error);
        this.tick = tick;
