...
public class ResponseUpgradeTower extends BaseMsg {
    private int tick;
    ...
    public ResponseUpgradeTower(Short error, int tick, String battleId, int i, int j,
                                BattleController battleController, boolean isSwap) {
        super(CmdDefine.UPGRADE_TOWER,error);
        this.tick = tick;
