...
public class FresherExtension extends BZExtension {
    ...
    public static String SERVERS_INFO2 =
            ConfigHandle.instance().get("servers_key") == null ? "servers" : ConfigHandle.instance().get("servers_key");
    ...
    public void init() {
        ...
        addRequestHandler(FindMatchHandler.FIND_MATCH_MULTI_IDS, FindMatchHandler.class);
        addRequestHandler(BattleHandler.BATTLE_MULTI_IDS, BattleHandler.class);
        addRequestHandler(BattleServerHandler.BATTLE_SERVER_MULTI_IDS, BattleServerHandler.class);
        /**
         * register new event
         */
        trace(" Event Handler ");
